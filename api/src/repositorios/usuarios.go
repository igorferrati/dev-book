...
// Buscar trás todos usuários que atendem um filtro de nome ou nick
...
// Deletar remove usuario no banco de dados
...
// BuscarSeguindo busca todos usuário que um usuário está seguindo
