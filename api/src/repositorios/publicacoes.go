...
// Publicacoes representa um repositório de publicacões
type Publicacoes struct {
	db *sql.DB
}

// NovoRepositorioDePublicacoes cria um repositório de publicacões
...
// Buscar traz as publicações dos usuários seguidos e também do próprio usuário que fez a requisição (feed)
...
// BuscarPorUsuario traz todas publicacoes de um usuário específico
...
// Curtir adiciona uma curtida na publicacão
...
// Descurtir subtrai uma curtida na publicacão
